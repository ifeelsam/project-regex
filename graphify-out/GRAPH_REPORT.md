# Graph Report - project-regex  (2026-06-19)

## Corpus Check
- 65 files · ~22,633 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 344 nodes · 487 edges · 28 communities (21 shown, 7 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 52 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9e2286fd`
...
- `boot()` --calls--> `fetch()`  [INFERRED]
  design/support.js → src-tauri/src/metadata/mod.rs
...
Cohesion: 0.05
Nodes (52): get_detail(), IdeaDetail, list_develop(), capture(), dedupes_on_url(), find_by_url(), get(), ItemWithTags (+44 more)
...
Cohesion: 0.13
Nodes (20): shellVariant, ready, @tauri-apps/api/core, @tauri-apps/api/event, $app/navigation, @tauri-apps/plugin-opener, shipped, $lib/components/BreakdownPanel.svelte (+12 more)
...
Cohesion: 0.07
Nodes (39): boot(), collectProps(), compileAttr(), compileTemplate(), createComponentFactory(), createExternalModules(), createHelmetManager(), createPseudoSheet() (+31 more)

### Community 6 - "Community 6"
Cohesion: 0.25
Nodes (7): 1. Logo & marks, 2. Color, 3. Type, 4. Components, 5. Screens, code:html (<link href="https://fonts.googleapis.com/css2?family=Bricola), Project Regex — Design System

### Community 7 - "Community 7"
Cohesion: 0.18
Nodes (14): fetch(), fetch_oembed(), fetch_open_graph(), fetch_youtube_oembed(), LinkMetadata, meta_content(), download_thumbnail(), enrich_item() (+6 more)
...
Cohesion: 0.33
Nodes (4): init(), AppState, run(), main()
...
## Knowledge Gaps
- **83 isolated node(s):** `config`, `MediaToolsStatus`, `AppState`, `ItemEnrichedEvent`, `BreakdownProgress` (+78 more)
...
- **Why does `run()` connect `Community 13` to `Community 0`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `run_enrichment()` connect `Community 7` to `Community 0`?**
